...
#video_path = "./VIDEOS/HW_video.mp4"
#video_path = "./VIDEOS/HW_ped_low.mp4"
video_path = "./VIDEOS/HW_19sec.mp4"

yolo = Load_Yolo_model()
#detect_image(yolo, image_path, "./IMAGES/kite_pred.jpg", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
detect_video(yolo, video_path, "./VIDEOS/HW_19sec_result.mp4", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
